...
def main():
    ...
    parser.add_argument(
        '-yaml', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/train.yml', help='Path to yaml file.')
    parser.add_argument(
        '-model', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/checkpoint/Conv_Tasnet/best.pt', help="Path to model file.")
    parser.add_argument(
        '-gpuid', type=str, default='0', help='Enter GPU id number')
    parser.add_argument(
        '-save_path', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/result/conv_tasnet/', help='save result path')
