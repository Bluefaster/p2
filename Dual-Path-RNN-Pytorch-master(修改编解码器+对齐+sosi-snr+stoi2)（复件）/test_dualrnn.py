...
def main():
    ...
    parser.add_argument(
        '-mix_scp', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/tt_mix.scp', help='Path to mix scp file.')
    parser.add_argument(
        '-yaml', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/config/Dual_RNN/train.yml', help='Path to yaml file.')
    parser.add_argument(
        '-model', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/checkpoint/Dual_Path_RNN/best.pt', help="Path to model file.")
    parser.add_argument(
        '-gpuid', type=str, default='0', help='Enter GPU id number')
    parser.add_argument(
        '-save_path', type=str, default='/home/cxw/Blue/Dual-Path-RNN-Pytorch-master/result/dual-rnn/', help='save result path')
